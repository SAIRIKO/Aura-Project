...
import { View, TextInput, Text, TouchableOpacity, Image, Alert, Modal, ActivityIndicator } from "react-native";
...
export default function Login({ navigation }: LoginProps) {
    ...
    return (
        <View style={{ backgroundColor: "#FFFFFF", flex: 1, marginTop: 40, alignItems: "center" }}>
            <View style={{ backgroundColor: "#F3F3F3", width: "100%", display: "flex", justifyContent: "flex-start", flexDirection: "row", paddingTop: 20 }}>
                {/* Logo */}
