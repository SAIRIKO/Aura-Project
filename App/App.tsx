...
export default function App() {
  ...
  const produtosComDesconto = [
    { id: '1', nome: 'Lactosil 10.000 FCC \nLactase 30...', preco: 'R$ 22,96', unidades: '30un', image: require('./assets/remedios/lactosil.png'), desconto: '-20%' },
    { id: '2', nome: 'Cálcio OS-Cal\n500mg 60...', preco: 'R$ 54,38', unidades: '60s', image: require('./assets/remedios/oscal.png'), desconto: '-15%' },
    { id: '3', nome: 'Dorflex Uno\nEfervescente', preco: 'R$ 28,99', unidades: '10un', image: require('./assets/remedios/dorflex.png'), desconto: '-10%' },
    { id: '4', nome: 'Buscopan Composto\nAdulto 10mg+...', preco: 'R$ 20,87', unidades: '20c', image: require('./assets/remedios/buscopan.png'), desconto: '-23%' },
    { id: '5', nome: 'Ibuprofeno 400mg\nMedley', preco: 'R$ 21,49', unidades: '10cps', image: require('./assets/remedios/ibuprofeno.png'), desconto: '-17%' },
    { id: '6', nome: 'Cloridrato Tramadol 37,5mg + Praceta...', preco: 'R$ 55,90', unidades: '30c', image: require('./assets/remedios/paracetamol.png'), desconto: '-38%' },
  ];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', marginTop: 0, height: 'auto' }} >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Image source={require('./assets/ph.png')} style={{ width: '100%', height: undefined, aspectRatio: 402 / 1061, opacity: 0, zIndex: 10, top: -79, position: 'absolute' }} resizeMode="contain" />

        {/* Barra de Pesquisa */}
        <View style={{ backgroundColor: 'transparent', height: 90, width: '100%', alignItems: 'center', display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
          ...
          <Animated.FlatList
            ...
            renderItem={({ item }) => (
              <View style={{ width: 141, height: 201, backgroundColor: '#F7F7F7', borderRadius: 12, padding: 0, shadowColor: '#000', shadowOpacity: 0.25, shadowOffset: { width: 2, height: 4 }, shadowRadius: 4, elevation: 3, justifyContent: 'center' }}>
                ...
                <Text style={{ fontSize: 12, fontFamily: 'Inter', fontWeight: '600', color: '#1A1B4F', top: -58, marginLeft: 8 }}>{item.nome}</Text>
